...
<div class="titlebar" data-tauri-drag-region>
  <div class="win-controls">
    <button class="win-btn" aria-label="Minimieren" onclick={() => appWindow.minimize()}>
      <svg width="11" height="11" viewBox="0 0 12 12"><line x1="2" y1="6" x2="10" y2="6" stroke="currentColor" stroke-width="1.2" /></svg>
    </button>
    <button class="win-btn" aria-label="Maximieren" onclick={() => appWindow.toggleMaximize()}>
    ...
    <button class="win-btn close" aria-label="Schließen" onclick={() => appWindow.close()}>
